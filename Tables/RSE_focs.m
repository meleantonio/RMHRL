...
lambda1Next_s1s1 = funeval(parlambda1,fspace,PHINext_s1s1 );
lambda1Next_s1s2 = funeval(parlambda1,fspace,PHINext_s1s2  );
lambda1Next_s2s1 = funeval(parlambda1,fspace,PHINext_s2s1);
lambda1Next_s2s2 = funeval(parlambda1,fspace,PHINext_s2s2  );
%
lambda2Next_s1s1 = funeval(parlambda2,fspace,PHINext_s1s1 );
lambda2Next_s1s2 = funeval(parlambda2,fspace,PHINext_s1s2 );
lambda2Next_s2s1 = funeval(parlambda2,fspace,PHINext_s2s1 );
lambda2Next_s2s2 = funeval(parlambda2,fspace,PHINext_s2s2  );
...
incent1 =  -epsil*alpha.*(a1.^(epsil-1)) - epsil*(epsil-1)*alpha.*(a1.^(epsil-2)).*lambda1 ...
    +  betta.*lambda1.*prob2_s1.*(prob1_s1.*dlike_ratio1_s1.*utilityNext1_s1s1 ...
    + prob1_s2.*dlike_ratio1_s2.*utilityNext1_s2s1) ...
    +  betta.*lambda1.*prob2_s2.*(prob1_s1.*dlike_ratio1_s1.*utilityNext1_s1s2 ...
    + prob1_s2.*dlike_ratio1_s2.*utilityNext1_s2s2) ;

incent2 =  -epsil*alpha.*(a2.^(epsil-1)) - epsil*(epsil-1)*alpha.*(a2.^(epsil-2)).*lambda2 ...
    +  betta.*lambda2.*prob2_s1.*(prob1_s1.*dlike_ratio2_s1.*utilityNext2_s1s1 ...
    + prob1_s2.*dlike_ratio2_s1.*utilityNext2_s2s1) ...
    +  betta.*lambda2.*prob2_s2.*(prob1_s1.*dlike_ratio2_s2.*utilityNext2_s1s2 ...
    + prob1_s2.*dlike_ratio2_s2.*utilityNext2_s2s2) ;

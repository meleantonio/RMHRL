...
equ4 =  -epsil*alpha.*(a1.^(epsil-1)).*phi1 - epsil*(epsil-1)*alpha.*(a1.^(epsil-2)).*lambda1 ...
    ...
    + prob1_s2.*dlike_ratio1_s2.*funeval(parexp2,fspace,phiNext1_s2 )) ...
...
equ4bis =  -epsil*alpha.*(a2.^(epsil-1)).*phi1 - epsil*(epsil-1)*alpha.*(a2.^(epsil-2)).*lambda2 ...
    +( betta.*lambda2.*(prob2_s1.*dlike_ratio2_s1.*funeval(parexp1,fspace,phiNext2_s1 ) + ...
    prob2_s2.*dlike_ratio2_s2.*exp_disc_utility2_next_s2) ...
